...
public class ItemGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Picasso.with(context).load(items[position]).placeholder(ContextCompat.getDrawable(context, R.drawable.placeholder)).into(holder.imgItem);
        return view;
    }
